...
//		System.out.println(context.getResources().getText(attrs.getAttributeResourceValue(null, "layout_marginBottom", 0)).toString() + "aaaaaaa");
		this.setFocusable(true);
		//图片显示，使其适应屏幕  http://blog.csdn.net/larryl2003/article/details/6919513
		...
		focusPaint.setStyle(Paint.Style.STROKE); //空心
